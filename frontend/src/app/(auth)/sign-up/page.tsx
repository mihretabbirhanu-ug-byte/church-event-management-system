...
export default function SignUpPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#f7f6f5]">
      <div className="flex w-full max-w-6xl items-stretch overflow-hidden rounded-xl shadow-xl">
        {/* Left promo image panel (1/3 width) */}
        <div className="relative flex-1 h-190 bg-[url('/pexels-dan-borges-2090916.jpg')] bg-cover bg-center">
          ...
          <div className="relative z-10 flex h-full flex-col items-center justify-center p-8 text-center text-white">
            ...
            <p className="mt-4 max-w-sm text-base leading-relaxed">
              Be part of upcoming church events. Connect with members, volunteer
              for tasks, and grow together in faith.
            </p>
          </div>
        </div>

        {/* Right sign-up box (2/3 width) */}
        <div className="flex-2 flex h-190 flex-col justify-center bg-white p-10">
